...
let basket; // 바구니
let timer = 1000; // 별이 떨어지는 간격을 설정할 시간
...
function case0_On(x, y, scX, scY) {
  ...
  if (
    ...
    mouseX < (width * 3) / 5 &&
    mouseY > height - (height * 2) / 7 &&
    mouseY < (height * 5) / 7 + height / 12
  ) {
    image(button[1], width / 2, (height * 53) / 70, width / 5, height / 12);
    if (mouseIsPressed) {
      rectMode(CENTER);
      noStroke();
      fill(151, 126, 156, 100);
      rect(width / 2, (height * 53) / 70, width / 5, height / 12);
    }
  } else {
  ...
  if (
    mouseX > width - (width * 3) / 5 &&
    mouseX < (width * 3) / 5 &&
    mouseY > height - (height * 12) / 70 &&
    mouseY < (height * 58) / 70 + height / 12
  ) {
    ...
    if (mouseIsPressed) {
      ...
      noStroke();
      fill(151, 126, 156, 100);
      rect(width / 2, (height * 61) / 70, width / 5, height / 12);
    }
  } else {
...
function case1_On(x, y, scX, scY) {
  ...
  if (
    ...
    mouseY > (height * 82) / 100 &&
    mouseY < (height * 82) / 100 + height / 11
  ) {
    // se5.play();
    image(
      button[4],
...
function case2_On(x, y, scX, scY) {
  ...
  if (
    ...
    mouseY > (height * 79) / 100 &&
    mouseY < (height * 79) / 100 + height / 11
  ) {
    image(
      button[5],
      (width * 69) / 100,
...
function case5_On(x, y, scX, scY) {
  ...
  if (
    mouseX > (width * 74) / 100 &&
    mouseX < (width * 74) / 100 + (width * 3.2) / 19 &&
    mouseY > (height * 77) / 100 &&
    mouseY < (height * 77) / 100 + height / 11
  ) {
    image(
      button[7],
      (width * 74) / 100,
...
function case9_On(x, y, scX, scY) {
  ...
  if (
    ...
    mouseY > (height * 87) / 100 &&
    mouseY < (height * 87) / 100 + height / 11
  ) {
    image(
      button[9],
      (width * 86) / 100,
...
function lv1_Game(convey) {
  ...
  if ((frameCount * 4) % 211 == 0) {
    lv1_Star();
    timer += 3500; //별 떨어지는 빈도 조절
  }
...
function lv4_game() {
  ...
  // if(lv4_breads[spaceCount].c == lv4_stars[lv4_stars.length - 3].c){
  //   se2.play();
  //   lv4_failure++;
  // }

  // for (let i=5;i>0;i--){
  //   lv4_breads[lv4_breads.length - i].display();
  // }
